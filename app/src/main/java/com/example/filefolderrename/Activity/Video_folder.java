...
public class Video_folder extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new VideoFragment(this, this, mediaselectedlist), "Videos");
